...
def create_user(
    ...
    if existing_user is not None:
        raise HTTPException(
            ...
            detail=f"User with e-mail {user.email} already exists.",
        )
...
def login_user(
    ...
    refresh_token: schemas.Token = create_refresh_token(
...
def refresh_token(request: Request, response: Response) -> schemas.Token:
